...
class AuthService {
  static async login(globalTreeDataProvider) {
    try {
      ...
      server.on('request', async (req, res) => {
        if (req.url.startsWith('/oauth/callback')) {
          ...
          await AuthService.handleTokens(req, res, port, state, globalTreeDataProvider);
          server.close();
        }
      });
  ...
  static async handleTokens(req, res, port, state, globalTreeDataProvider) {
